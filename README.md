...
Clone this repository using `git clone --recurse-submodules https://github.com/Alexyo21/open_agb_firm`and update via `git pull && git submodule update --init --recursive`.
